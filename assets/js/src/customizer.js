...
( function( $ ) {
	...
	//Stroke
	var $stroke_options = { "scrolltop_color": ".back-to-top svg", "color_link_hover": ".has-cross-sells-carousel .cross-sells .botiga-carousel-wrapper .botiga-carousel-nav svg path"};
