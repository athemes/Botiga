            ...
            <div class="botiga-dashboard-module-card">
                <div class="botiga-dashboard-module-card-header">
                    ...
                    <div class="botiga-dashboard-module-card-header-actions">
                        <a href="https://athemes.com/botiga-upgrade?utm_source=theme_dashboard_settings_general_features&utm_medium=link&utm_campaign=Botiga" class="botiga-dashboard-external-link" target="_blank">
