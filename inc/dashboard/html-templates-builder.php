                ...
                <div class="botiga-dashboard-column botiga-dashboard-column-3">
                    <nav class="bt-navigation-links">
                        <ul>
                            ...
                            <li>
                                <a href="https://docs.athemes.com/article/pro-templates-builder/" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" aria-hidden="true" focusable="false">
                ...
                <div class="botiga-dashboard-column botiga-dashboard-column-9">
                    ...
                    <div class="botiga-dashboard-card botiga-dashboard-card-no-box-shadow">
                        <div class="botiga-dashboard-card-inner-header with-border-bottom bt-mb-10px">
                            <h2 class="bt-font-size-20px bt-mb-10px bt-mt-0">Create New</h2>
                            <p class="bt-text-color-grey bt-mt-0">Start from scratch and design a custom template tailored to your specific needs.</p>
                        </div>
                                    ...
                                    <div data-wp-c16t="true" data-wp-component="Card" class="components-surface components-card bt-template-card bt-template-card--create-new css-1pd4mph e19lxcc00">
                                        <div class="css-10klw3m e19lxcc00">
                                            ...
                                            <div data-wp-c16t="true" data-wp-component="CardBody" class="components-card__body components-card-body bt-template-card__body css-188a3xf e19lxcc00">
                                                ...
                                                <img src="https://botigadev.ddev.site/wp-content/plugins/botiga-pro/inc/modules/templates-builder/v3/assets/images/single-post.svg" alt="Single">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div data-wp-c16t="true" data-wp-component="Card" class="components-surface components-card bt-template-card bt-template-card--create-new css-1pd4mph e19lxcc00">
                                        <div class="css-10klw3m e19lxcc00">
                                            ...
                                            <div data-wp-c16t="true" data-wp-component="CardBody" class="components-card__body components-card-body bt-template-card__body css-188a3xf e19lxcc00">
                                                ...
                                                <img src="https://botigadev.ddev.site/wp-content/plugins/botiga-pro/inc/modules/templates-builder/v3/assets/images/post-archives.svg" alt="Archive">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div data-wp-c16t="true" data-wp-component="Card" class="components-surface components-card bt-template-card bt-template-card--create-new css-1pd4mph e19lxcc00">
                                        <div class="css-10klw3m e19lxcc00">
                                            ...
                                            <div data-wp-c16t="true" data-wp-component="CardBody" class="components-card__body components-card-body bt-template-card__body css-188a3xf e19lxcc00">
                                                ...
                                                <img src="https://botigadev.ddev.site/wp-content/plugins/botiga-pro/inc/modules/templates-builder/v3/assets/images/single-page.svg" alt="Page">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div data-wp-c16t="true" data-wp-component="Card" class="components-surface components-card bt-template-card bt-template-card--create-new css-1pd4mph e19lxcc00">
                                        <div class="css-10klw3m e19lxcc00">
                                            ...
                                            <div data-wp-c16t="true" data-wp-component="CardBody" class="components-card__body components-card-body bt-template-card__body css-188a3xf e19lxcc00">
                                                ...
                                                <img src="https://botigadev.ddev.site/wp-content/plugins/botiga-pro/inc/modules/templates-builder/v3/assets/images/404.svg" alt="404">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div data-wp-c16t="true" data-wp-component="Card" class="components-surface components-card bt-template-card bt-template-card--create-new css-1pd4mph e19lxcc00">
                                        <div class="css-10klw3m e19lxcc00">
                                            ...
                                            <div data-wp-c16t="true" data-wp-component="CardBody" class="components-card__body components-card-body bt-template-card__body css-188a3xf e19lxcc00">
                                                ...
                                                <img src="https://botigadev.ddev.site/wp-content/plugins/botiga-pro/inc/modules/templates-builder/v3/assets/images/content-block.svg" alt="Content Block">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div data-wp-c16t="true" data-wp-component="Card" class="components-surface components-card bt-template-card bt-template-card--create-new css-1pd4mph e19lxcc00">
                                        <div class="css-10klw3m e19lxcc00">
                                            ...
                                            <div data-wp-c16t="true" data-wp-component="CardBody" class="components-card__body components-card-body bt-template-card__body css-188a3xf e19lxcc00">
                                                ...
                                                <img src="https://botigadev.ddev.site/wp-content/plugins/botiga-pro/inc/modules/templates-builder/v3/assets/images/single-product.svg" alt="Single Product">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div data-wp-c16t="true" data-wp-component="Card" class="components-surface components-card bt-template-card bt-template-card--create-new css-1pd4mph e19lxcc00">
                                        <div class="css-10klw3m e19lxcc00">
                                            ...
                                            <div data-wp-c16t="true" data-wp-component="CardBody" class="components-card__body components-card-body bt-template-card__body css-188a3xf e19lxcc00">
                                                ...
                                                <img src="https://botigadev.ddev.site/wp-content/plugins/botiga-pro/inc/modules/templates-builder/v3/assets/images/product-archives.svg" alt="Shop Archive">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div data-wp-c16t="true" data-wp-component="Card" class="components-surface components-card bt-template-card bt-template-card--create-new css-1pd4mph e19lxcc00">
                                        <div class="css-10klw3m e19lxcc00">
                                            ...
                                            <div data-wp-c16t="true" data-wp-component="CardBody" class="components-card__body components-card-body bt-template-card__body css-188a3xf e19lxcc00">
                                                ...
                                                <img src="https://botigadev.ddev.site/wp-content/plugins/botiga-pro/inc/modules/templates-builder/v3/assets/images/order-received-page.svg" alt="Order Thank You">
                                            </div>
                                        </div>
                                    </div>
                                </div>
