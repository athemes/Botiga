<div class="botiga-dashboard-card botiga-dashboard-card-no-box-shadow">
    <div class="botiga-dashboard-card-inner-header bt-mb-10px">
        <h2 class="bt-font-size-20px bt-mb-10px bt-mt-0">Filter presets</h2>
        ...
        <div class="bt-presets-list__body">
            <div class="bt-presets-list__item">
                ...
                <div class="bt-presets-list__item-actions">
                    <a href="<?php echo esc_url( $this->settings['upgrade_pro'] ); ?>" class="button button-primary botiga-dashboard-pro-tooltip" data-tooltip-message="<?php echo esc_attr__( 'This is only available on Botiga Pro', 'botiga' ); ?>" target="_blank">Edit</a>
                    <a href="<?php echo esc_url( $this->settings['upgrade_pro'] ); ?>" class="button button-secondary botiga-dashboard-pro-tooltip" data-tooltip-message="<?php echo esc_attr__( 'This is only available on Botiga Pro', 'botiga' ); ?>" target="_blank">Remove</a>
                </div>
            </div>
        </div>
        <a href="<?php echo esc_url( $this->settings['upgrade_pro'] ); ?>" class="button button-secondary bt-presets-list__add-button botiga-dashboard-pro-tooltip" data-tooltip-message="<?php echo esc_attr__( 'This is only available on Botiga Pro', 'botiga' ); ?>" target="_blank">+ Add new preset</a>
    </div>
