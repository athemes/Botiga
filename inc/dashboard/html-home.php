        ...
        <div class="botiga-dashboard-card">
            <div class="botiga-dashboard-card-header bt-d-flex bt-justify-content-between bt-align-items-center">
                ...
                <?php if( ! $this->settings[ 'has_pro' ] ) : ?>
                    <a href="https://athemes.com/botiga-upgrade?utm_source=theme_dashboard&utm_content=do_more_bp_link&utm_medium=link&utm_campaign=Botiga" class="botiga-dashboard-external-link" target="_blank">
                            ...
                            <div class="botiga-dashboard-feature-card">
                                ...
                                <div class="botiga-dashboard-feature-card-actions">
                                    <?php if( ! $this->settings[ 'has_pro' ] ) : ?>
                                        ...
                                        <?php endif; ?>
                                        <a href="https://athemes.com/botiga-upgrade?utm_source=theme_dashboard&utm_content=pro_card_<?php echo esc_attr( sanitize_title( $feature[ 'title' ] ) ); ?>&utm_medium=link&utm_campaign=Botiga" class="botiga-dashboard-feature-card-link-icon botiga-dashboard-feature-card-link-icon-always-visible botiga-dashboard-pro-tooltip" target="_blank" data-tooltip-message="<?php echo esc_attr__( 'This option is only available on Botiga Pro', 'botiga' ); ?>">
            ...
            <?php if( ! $this->settings[ 'has_pro' ] ) : ?>
                ...
                <div class="botiga-dashboard-card bt-border-color-primary">
                    ...
                    <div class="botiga-dashboard-card-body">
                        ...
                        <a href="https://athemes.com/botiga-upgrade?utm_source=theme_dashboard&utm_content=get_premium_support&utm_medium=link&utm_campaign=Botiga" class="botiga-dashboard-external-link" target="_blank">
