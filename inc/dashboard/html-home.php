        ...
        <div class="botiga-dashboard-card">
            <div class="botiga-dashboard-card-header bt-d-flex bt-justify-content-between bt-align-items-center">
                ...
                <?php if( ! $this->settings[ 'has_pro' ] ) : ?>
                    <a href="https://athemes.com/botiga-upgrade?utm_source=theme_dashboard_do_more_bp_link&utm_medium=link&utm_campaign=Botiga" class="botiga-dashboard-external-link" target="_blank">
            ...
            <?php if( ! $this->settings[ 'has_pro' ] ) : ?>
                ...
                <div class="botiga-dashboard-card bt-border-color-primary">
                    ...
                    <div class="botiga-dashboard-card-body">
                        ...
                        <a href="https://athemes.com/botiga-upgrade?utm_source=theme_dashboard_get_premium_support&utm_medium=link&utm_campaign=Botiga" class="botiga-dashboard-external-link" target="_blank">
