		...
		<div class="botiga-dashboard-content">
			<div class="botiga-dashboard-row">
				<div class="botiga-dashboard-box botiga-dashboard-box-features">
					<div class="botiga-dashboard-box-title"><?php esc_html_e('Common Features', 'botiga'); ?></div>
					<div class="botiga-dashboard-box-content">
						<div class="botiga-dashboard-features-list">
							...
							<ul>
								...
								<li><a href="<?php echo esc_url(add_query_arg('autofocus[section]', 'botiga_section_modal_popup', admin_url('customize.php'))); ?>" target="_blank"><?php esc_html_e('Modal Popup Options', 'botiga'); ?></a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="botiga-dashboard-row">
				<div class="botiga-dashboard-column">
					<div class="botiga-dashboard-box botiga-dashboard-box-facebook-community">
						<div class="botiga-dashboard-box-title"><?php esc_html_e('Join Our Facebook Community', 'botiga'); ?></div>
						<div class="botiga-dashboard-box-content">
							<?php esc_html_e('Discuss products and ask for community support or help the community.', 'botiga'); ?>
						</div>
						<div class="botiga-dashboard-box-link">
							<a href="<?php echo esc_url($this->settings['community_link']); ?>" target="_blank" class="button button-secondary"><?php esc_html_e('Join Now', 'botiga'); ?></a>
						</div>
					</div>
			...
			<div class="botiga-dashboard-row">
				<div class="botiga-dashboard-column">
					...
					<div class="botiga-dashboard-box botiga-dashboard-box-changelog">
						...
						<div class="botiga-dashboard-box-content">
							<?php esc_html_e('Keep up to date with the latest changes.', 'botiga'); ?>
						</div>
						<div class="botiga-dashboard-box-link">
