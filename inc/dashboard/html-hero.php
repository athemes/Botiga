	...
	<div class="botiga-dashboard-hero-content">
		...
		<?php if ('themes.php' === $pagenow && 'themes' === $screen->base) : ?>
			...
			<div class="botiga-dashboard-hero-actions">
				...
				<?php else : ?>
					<a href="<?php echo esc_url(add_query_arg(array('page' => $this->settings['menu_slug'], 'tab' => 'starter-sites'), admin_url('themes.php'))); ?>" class="button button-primary botiga-dashboard-hero-button">
						<?php esc_html_e('Starter Sites', 'botiga'); ?>
					</a>
				<?php endif; ?>
