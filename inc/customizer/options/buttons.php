...
$wp_customize->add_control( new Botiga_Typography_Adobe_Control( $wp_customize, 'button_adobe_font',
	array(
		'section'         => 'botiga_section_buttons',
...
$wp_customize->add_control( new Botiga_Typography_Control( $wp_customize, 'button_font',
	array(
		'section'  => 'botiga_section_buttons',
		'settings' => array (
			'family' => 'button_font',
...
$wp_customize->add_control( new Botiga_Responsive_Slider( $wp_customize, 'button_letter_spacing',
	array(
...
$wp_customize->add_control( new Botiga_Text_Style_Control( $wp_customize, 'button_text',
  array(
    'section'  => 'botiga_section_buttons',
    'settings' => array(
