...
// $wp_customize->add_setting(
// 	'header_floating_display_on_front_page',
// 	array(
// 		'default'           => 1,
// 		'sanitize_callback' => 'botiga_sanitize_checkbox',
// 	)
...
// 		'header_floating_display_on_front_page',
// 		array(
// 			'label'         	=> esc_html__( 'Include on Front Page', 'botiga' ),
// 			'section'       	=> 'botiga_section_main_header',
// 			'active_callback'   => 'botiga_floating_header_enabled',
// 			'priority'		    => 21
// 		)
...
// $wp_customize->add_setting(
// 	'header_floating_display_on_blog_archive',
// 	array(
// 		'default'           => 0,
// 		'sanitize_callback' => 'botiga_sanitize_checkbox',
// 	)
...
// 		'header_floating_display_on_blog_archive',
// 		array(
// 			'label'         	=> esc_html__( 'Include on Blog Archive', 'botiga' ),
// 			'section'       	=> 'botiga_section_main_header',
// 			'active_callback'   => 'botiga_floating_header_enabled',
// 			'priority'		    => 21
// 		)
...
// $wp_customize->add_setting(
// 	'header_floating_display_on_blog_posts',
// 	array(
// 		'default'           => 0,
// 		'sanitize_callback' => 'botiga_sanitize_checkbox',
// 	)
...
// 		'header_floating_display_on_blog_posts',
// 		array(
// 			'label'         	=> esc_html__( 'Include on Blog Posts', 'botiga' ),
// 			'section'       	=> 'botiga_section_main_header',
// 			'active_callback'   => 'botiga_floating_header_enabled',
// 			'priority'		    => 21
// 		)
...
// 	$wp_customize->add_setting(
// 		'header_floating_display_on_shop_archive',
// 		array(
// 			'default'           => 0,
// 			'sanitize_callback' => 'botiga_sanitize_checkbox',
// 		)
...
// 			'header_floating_display_on_shop_archive',
// 			array(
// 				'label'         	=> esc_html__( 'Include on Shop Catalog', 'botiga' ),
// 				'section'       	=> 'botiga_section_main_header',
// 				'active_callback'   => 'botiga_floating_header_enabled',
// 				'priority'		    => 21
// 			)
...
// 	$wp_customize->add_setting(
// 		'header_floating_display_on_shop_products',
// 		array(
// 			'default'           => 0,
// 			'sanitize_callback' => 'botiga_sanitize_checkbox',
// 		)
...
// 			'header_floating_display_on_shop_products',
// 			array(
// 				'label'         	=> esc_html__( 'Include on Shop Products', 'botiga' ),
// 				'section'       	=> 'botiga_section_main_header',
// 				'active_callback'   => 'botiga_floating_header_enabled',
// 				'priority'		    => 21
// 			)
...
// 	$wp_customize->add_setting(
// 		'header_floating_display_on_shop_cart',
// 		array(
// 			'default'           => 0,
// 			'sanitize_callback' => 'botiga_sanitize_checkbox',
// 		)
...
// 			'header_floating_display_on_shop_cart',
// 			array(
// 				'label'         	=> esc_html__( 'Include on Shop Cart', 'botiga' ),
// 				'section'       	=> 'botiga_section_main_header',
// 				'active_callback'   => 'botiga_floating_header_enabled',
// 				'priority'		    => 21
// 			)
...
// 			'header_floating_display_on_shop_checkout',
// 			array(
// 				'label'         	=> esc_html__( 'Include on Shop Checkout', 'botiga' ),
// 				'section'       	=> 'botiga_section_main_header',
// 				'active_callback'   => 'botiga_floating_header_enabled',
// 				'priority'		    => 21
// 			)
...
// 	$wp_customize->add_setting(
// 		'header_floating_display_on_shop_myaccount',
// 		array(
// 			'default'           => 0,
// 			'sanitize_callback' => 'botiga_sanitize_checkbox',
// 		)
...
// 			'header_floating_display_on_shop_myaccount',
// 			array(
// 				'label'         	=> esc_html__( 'Include on My Account', 'botiga' ),
// 				'section'       	=> 'botiga_section_main_header',
// 				'active_callback'   => 'botiga_floating_header_enabled',
// 				'priority'		    => 21
// 			)
...
// $wp_customize->add_setting(
// 	'header_floating_display_on_search',
// 	array(
// 		'default'           => 0,
// 		'sanitize_callback' => 'botiga_sanitize_checkbox',
// 	)
...
// 		'header_floating_display_on_search',
// 		array(
// 			'label'         	=> esc_html__( 'Include on Posts Search Results', 'botiga' ),
// 			'section'       	=> 'botiga_section_main_header',
// 			'active_callback'   => 'botiga_floating_header_enabled',
// 			'priority'		    => 21
// 		)
...
// $wp_customize->add_setting(
// 	'header_floating_display_on_404',
// 	array(
// 		'default'           => 0,
// 		'sanitize_callback' => 'botiga_sanitize_checkbox',
// 	)
...
// 		'header_floating_display_on_404',
// 		array(
// 			'label'         	=> esc_html__( 'Include on 404 Page', 'botiga' ),
// 			'section'       	=> 'botiga_section_main_header',
// 			'active_callback'   => 'botiga_floating_header_enabled',
// 			'priority'		    => 21
// 		)
	...
	new Botiga_Select2_Control(
		...
		array(
			...
			'choices'         => array(
				...
				'shop-catalog'  	=> __( 'Shop Catalog', 'botiga' ),
				'shop-products' 	=> __( 'Shop Products', 'botiga' ),
				'shop-cart' 		=> __( 'Shop Cart', 'botiga' ),
				'shop-checkout' 	=> __( 'Shop Checkout', 'botiga' ),
				'shop-my-account' 	=> __( 'Shop My Account', 'botiga' ),
				'shop-wishlist' 	=> __( 'Shop Wishlist', 'botiga' ),
