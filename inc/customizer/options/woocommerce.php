...
// Display Conditions
$wp_customize->add_setting(
    'shop_archive_sidebar_display_conditions',
    array(
        'default'           => '[]',
...
$wp_customize->add_control(
    new Botiga_Display_Conditions_Control(
        ...
        'shop_archive_sidebar_display_conditions',
        array(
            'title'           => esc_html__( 'Shop Archives Sidebar Display Conditions', 'botiga' ),
