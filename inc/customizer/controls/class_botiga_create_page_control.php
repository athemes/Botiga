	...
	public function render_content() {
		...
		if( $page_id && post_exists( get_the_title( $page_id ) ) && get_post_status( $page_id ) === 'publish' ) {
			...
			echo '<div class="botiga-create-page-control-create-message">';
				...
				echo sprintf( __( 'It looks like you haven\'t created a <strong>%s</strong> page yet. Click the below button to create the page.', 'botiga' ), esc_html( $this->page_title ) );
				echo '<br><br>';
			echo '</div>';
