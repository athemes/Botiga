            ...
            'controls_design'		=> wp_json_encode(
                array_merge(
                    array(
                        ...
                        '#customize-control-botiga_section_fb_component__html_link',
                        '#customize-control-botiga_section_fb_component__html_padding',
                        '#customize-control-botiga_section_fb_component__html_margin'
                    ),
...
// Visibility
$wp_customize->add_setting( 
    'botiga_section_fb_component__html_visibility_desktop',
    array(
        'default' 			=> 'visible',
        'sanitize_callback' => 'botiga_sanitize_text',
        'transport'         => 'postMessage'
...
$wp_customize->add_setting( 
    'botiga_section_fb_component__html_visibility_tablet',
    array(
        'default' 			=> 'visible',
        'sanitize_callback' => 'botiga_sanitize_text',
        'transport'         => 'postMessage'
...
$wp_customize->add_setting( 
    'botiga_section_fb_component__html_visibility_mobile',
    array(
        'default' 			=> 'visible',
        'sanitize_callback' => 'botiga_sanitize_text',
        'transport'         => 'postMessage'
...
$wp_customize->add_control( 
    new Botiga_Radio_Buttons( 
        ...
        array(
            ...
            'is_responsive' => true,
            'settings' => array(
                'desktop' 		=> 'botiga_section_fb_component__html_visibility_desktop',
                'tablet' 		=> 'botiga_section_fb_component__html_visibility_tablet',
                'mobile' 		=> 'botiga_section_fb_component__html_visibility_mobile'
            ),
            'choices'       => array(
...
$wp_customize->add_control(
    new Botiga_Color_Group(
        $wp_customize,
        'botiga_section_fb_component__html_link',
        array(
            'label'    => esc_html__( 'Link Color', 'botiga' ),
            'section'  => 'botiga_section_fb_component__html',
            'settings' => array(
                'normal' => 'botiga_section_fb_component__html_link_color',
                'hover'  => 'botiga_section_fb_component__html_link_color_hover',
            ),
            'priority' => 41
        )
    )
...
// Padding
$wp_customize->add_setting( 
    'botiga_section_fb_component__html_padding_desktop',
    array(
...
$wp_customize->add_setting( 
    'botiga_section_fb_component__html_padding_tablet',
    array(
        'default'           => '{ "unit": "px", "linked": false, "top": "", "right": "", "bottom": "", "left": "" }',
        'sanitize_callback' => 'botiga_sanitize_text',
        'transport'         => 'postMessage'
...
$wp_customize->add_setting( 
    'botiga_section_fb_component__html_padding_mobile',
    array(
        'default'           => '{ "unit": "px", "linked": false, "top": "", "right": "", "bottom": "", "left": "" }',
        'sanitize_callback' => 'botiga_sanitize_text',
        'transport'         => 'postMessage'
...
$wp_customize->add_control( 
    new Botiga_Dimensions_Control( 
        ...
        array(
            ...
            'is_responsive'   	 => true,
            'settings'        	 => array(
                'desktop' => 'botiga_section_fb_component__html_padding_desktop',
                'tablet'  => 'botiga_section_fb_component__html_padding_tablet',
                'mobile'  => 'botiga_section_fb_component__html_padding_mobile'
            ),
            'priority'	      	 => 72
        )
    )
...
// Margin
$wp_customize->add_setting( 
    'botiga_section_fb_component__html_margin_desktop',
    array(
        'default'           => '{ "unit": "px", "linked": false, "top": "", "right": "", "bottom": "", "left": "" }',
        'sanitize_callback' => 'botiga_sanitize_text',
        'transport'         => 'postMessage'
...
$wp_customize->add_setting( 
    'botiga_section_fb_component__html_margin_tablet',
    array(
        'default'           => '{ "unit": "px", "linked": false, "top": "", "right": "", "bottom": "", "left": "" }',
        'sanitize_callback' => 'botiga_sanitize_text',
        'transport'         => 'postMessage'
...
$wp_customize->add_setting( 
    'botiga_section_fb_component__html_margin_mobile',
    array(
        'default'           => '{ "unit": "px", "linked": false, "top": "", "right": "", "bottom": "", "left": "" }',
        'sanitize_callback' => 'botiga_sanitize_text',
        'transport'         => 'postMessage'
...
$wp_customize->add_control( 
    new Botiga_Dimensions_Control( 
        ...
        array(
            ...
            'is_responsive'   	 => true,
            'settings'        	 => array(
                'desktop' => 'botiga_section_fb_component__html_margin_desktop',
                'tablet'  => 'botiga_section_fb_component__html_margin_tablet',
                'mobile'  => 'botiga_section_fb_component__html_margin_mobile'
            ),
            'priority'	      	 => 72
        )
    )
