...
<div class="bhfb-builder-item bhfb-component-button2" data-component-id="button2">
    ...
    $text 	= get_theme_mod( 'bhfb_button2_text', esc_html__( 'Click me', 'botiga-pro' ) );
    $url	= get_theme_mod( 'bhfb_button2_link', '#' );
    $class  = get_theme_mod( 'bhfb_button2_class', '' ); 
    $newtab = get_theme_mod( 'bhfb_button2_newtab', 0 );
