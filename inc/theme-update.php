...
function botiga_hf_update_notice_1_1_9() {
    ...
    <div class="notice notice-success thd-theme-dashboard-notice-success is-dismissible">
        ...
        <p>
            <?php echo sprintf( esc_html__( 'Want to see the new header and footer builder before upgrading? Check out our %s.', 'botiga' ), '<a target="_blank" href="https://docs.athemes.com/article/pro-header-builder/">documentation</a>' ); ?>
        </p>
