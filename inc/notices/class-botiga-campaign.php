...
class Botiga_Campaign_Notice {
	...
	public function review_notice_markup() {
        ...
        <div class="botiga-notice notice botiga-campaign-notice" style="position:relative;">
            ...
            <a href="https://athemes.com/black-friday/?utm_source=plugin_notice&utm_medium=button&utm_campaign=Merchant#botiga-pro" class="botiga-btn botiga-btn-primary" target="_blank"><?php esc_html_e( 'Give Me This Deal', 'botiga' ); ?></a>
