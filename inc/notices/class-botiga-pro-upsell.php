...
class Botiga_Pro_Upsell_Notice {
	...
	public function notice_markup() {
		...
		<div class="botiga-notice botiga-notice-with-thumbnail notice" style="position:relative;">
			...
			<a href="https://athemes.com/botiga-upgrade?utm_source=theme_notice&utm_medium=button&utm_campaign=Botiga" class="botiga-btn botiga-btn-secondary" target="_blank"><?php esc_html_e( 'Upgrade To Botiga', 'botiga' ); ?></a>
